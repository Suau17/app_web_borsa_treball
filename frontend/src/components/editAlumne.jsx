...
export function FormEditAlumne() {
    ...
    return (
        ...
        <h1 className="block text-gray-700 text-xl font-bold ">Edita la informació d'usuari</h1>
            ...
            <input type = "text" name = "email" required placeholder = "Entra el teu nou mail" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
            <span className="block text-gray-700  font-bold mb-2">Contrassenya</span>
            <input type = "password" name = "password" required placeholder = "Entra la nova contrassenya" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
            <span className="block text-gray-700  font-bold mb-2">Confirma la contrassenya</span>
            <input type = "password" name = "confirmpassword" required placeholder = "Confirma la teva contrassenya" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
