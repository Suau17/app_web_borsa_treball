        ...
        <h1 className="block text-gray-700 text-xl font-bold ">Edita la informació d'usuari</h1>
            ...
            {profile.user.rolUser === "gestor" ? (
                                <div>
                                    ...
                                    <span  className="block text-gray-700  font-bold mb-2">Càrrec</span>
                                    ...
                                    <span className="block text-gray-700  font-bold mb-2">Telèfon</span>
