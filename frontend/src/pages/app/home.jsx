  ...
  return (
    ...
    <div className='generalDiv'>
     <div className='infoEmpresa'>
      ...
      <li><a href='/register'>Registre per a empreses</a></li>
      <li>Totes les ofertes les publicarem al taulell d'ofertes <br></br><a href="/getOfertas">Taulell d'ofertes</a></li>
     ...
     <div className='infoUser'>
       ...
       <div className='listaH'>
       <ul>
        <li><a href='/register'>Registart i no et perdis cap oferta</a></li>
        <li>Com pots accedir a les ofertes?<br></br><a href="/getOfertas">Veure les ofertes</a></li>
       </ul><br />
     ...
     <div className='imgH2'><h2>Algunes empreses que treballen amb nosaltres</h2></div>
